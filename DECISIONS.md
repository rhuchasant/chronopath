...
## D8 · Counter-intuitive eval finding: smaller model outperforms larger on factual accuracy

**Observed:** In our 10-prompt × 2-model eval (see `evals/report.md`), Claude Haiku 4.5 scored 14.10/20 average vs Claude Sonnet 4.5's 13.30/20. Sonnet won on persona-fit (4.5 vs 4.2) but lost on factual accuracy (2.5 vs 3.1) and bias-awareness (2.9 vs 3.3). Sonnet's narratives triggered revision in 10/10 cases; Haiku's in 6/10.
...
- The result may not generalize to other corpora — it reflects how these two models handle this specific source set with these specific persona directives.
